...
public class Interface extends JFrame{
	...
	lbldolar.setBounds(20,20,245,40);
	
	paine.add(txtdolar);// caixa
	txtdolar.setBounds(80,30,140,20);
	
	paine.add(lblreais);// label
	lblreais.setBounds(20,100,245,40);
	
	paine.add(txtreais);// caixa
	txtreais.setBounds(80,110,140,20);
	...
	btnCalculo.addActionListener(new ActionListener(){
		 public void actionPerformed(ActionEvent e){
			 ...
			 txtreais.setText("" + calc.conversao(dolar));
		 }
	 });
	btnCalculo.setBounds(90,400,100,40);
	
	txtreais.setEditable(false);
	this.setLayout(null);
